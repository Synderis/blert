...
export enum SplitType {
  ...
  COX_ENTRY_CHALLENGE = 350,
  COX_REG_CHALLENGE = 351,
  COX_CM_CHALLENGE = 352,
  COX_CHALLENGE = COX_ENTRY_CHALLENGE,

  COX_ENTRY_OVERALL = 353,
  COX_REG_OVERALL = 354,
  COX_CM_OVERALL = 355,
  COX_OVERALL = COX_ENTRY_OVERALL,

  COX_ENTRY_TEKTON = 356,
  COX_REG_TEKTON = 357,
  COX_CM_TEKTON = 358,
  ...
  COX_ENTRY_ICE_DEMON = 362,
  COX_REG_ICE_DEMON = 363,
  COX_CM_ICE_DEMON = 364,
  COX_ICE_DEMON = COX_ENTRY_ICE_DEMON,

  COX_ENTRY_SHAMANS = 365,
  COX_REG_SHAMANS = 366,
  COX_CM_SHAMANS = 367,
  COX_SHAMANS = COX_ENTRY_SHAMANS,

  COX_ENTRY_VANGUARDS = 368,
  COX_REG_VANGUARDS = 369,
  COX_CM_VANGUARDS = 370,
  COX_VANGUARDS = COX_ENTRY_VANGUARDS,

  COX_ENTRY_THIEVING = 371,
  COX_REG_THIEVING = 372,
  COX_CM_THIEVING = 373,
  ...
  COX_ENTRY_VESPULA = 377,
  COX_REG_VESPULA = 378,
  COX_CM_VESPULA = 379,
  COX_VESPULA = COX_ENTRY_VESPULA,

  COX_ENTRY_TIGHTROPE = 380,
  COX_REG_TIGHTROPE = 381,
  COX_CM_TIGHTROPE = 382,
  COX_TIGHTROPE = COX_ENTRY_TIGHTROPE,

  COX_ENTRY_GUARDIANS = 383,
  COX_REG_GUARDIANS = 384,
  COX_CM_GUARDIANS = 385,
  COX_GUARDIANS = COX_ENTRY_GUARDIANS,

  COX_ENTRY_MYSTICS = 386,
  COX_REG_MYSTICS = 387,
  COX_CM_MYSTICS = 388,
  COX_MYSTICS = COX_ENTRY_MYSTICS,

  COX_ENTRY_MUTTADILE = 389,
  COX_REG_MUTTADILE = 390,
  COX_CM_MUTTADILE = 391,
