...
export enum NpcAttack {
  ...
  COX_TEKTON_ANVIL = NpcAttackProto.COX_TEKTON_ANVIL,
  COX_TEKTON_STAB = NpcAttackProto.COX_TEKTON_STAB,
  COX_TEKTON_SLASH = NpcAttackProto.COX_TEKTON_SLASH,
  COX_TEKTON_HAMMER = NpcAttackProto.COX_TEKTON_HAMMER,
  COX_TEKTON_LEFT_ANVIL = NpcAttackProto.COX_TEKTON_LEFT_ANVIL,
  COX_ICE_DEMON_AUTO = NpcAttackProto.COX_ICE_DEMON_AUTO,
  COX_SHAMANS_BARNEYS = NpcAttackProto.COX_SHAMANS_BARNEYS,
  COX_SHAMANS_BLOB = NpcAttackProto.COX_SHAMANS_BLOB,
  COX_SHAMANS_JUMP = NpcAttackProto.COX_SHAMANS_JUMP,
  COX_SHAMANS_MELEE = NpcAttackProto.COX_SHAMANS_MELEE,
  COX_VANGS_SPAWN = NpcAttackProto.COX_VANGS_SPAWN,
  COX_VANGS_MAGE = NpcAttackProto.COX_VANGS_MAGE,
  COX_VANGS_MELEE = NpcAttackProto.COX_VANGS_MELEE,
  COX_VANGS_RANGED = NpcAttackProto.COX_VANGS_RANGED,
  COX_VANGS_HEAL = NpcAttackProto.COX_VANGS_HEAL,
  COX_THIEVING_CHOMP = NpcAttackProto.COX_THIEVING_CHOMP,
  COX_THIEVING_SLEEP = NpcAttackProto.COX_THIEVING_SLEEP,
  COX_TIGHTROPE_MAGE = NpcAttackProto.COX_TIGHTROPE_MAGE,
  COX_TIGHTROPE_RANGE = NpcAttackProto.COX_TIGHTROPE_RANGE,
  COX_GUARDIANS_SWIPE = NpcAttackProto.COX_GUARDIANS_SWIPE,
  COX_GUARDIANS_ROCK_FALL = NpcAttackProto.COX_GUARDIANS_ROCK_FALL,
  COX_VASA_SPAWN = NpcAttackProto.COX_VASA_SPAWN,
  COX_VASA_TELEPORT = NpcAttackProto.COX_VASA_TELEPORT,
  COX_VASA_TELEPORT_BOMBS = NpcAttackProto.COX_VASA_TELEPORT_BOMBS,
  COX_VASA_AT_CRYSTAL = NpcAttackProto.COX_VASA_AT_CRYSTAL,
  COX_VASA_LEAVES_CRYSTAL = NpcAttackProto.COX_VASA_LEAVES_CRYSTAL,
  COX_MYSTICS_MAGE = NpcAttackProto.COX_MYSTICS_MAGE,
  COX_MYSTICS_MELEE = NpcAttackProto.COX_MYSTICS_MELEE,
  COX_MUTTA_MELEE = NpcAttackProto.COX_MUTTA_MELEE,
  COX_MUTTA_RANGE = NpcAttackProto.COX_MUTTA_RANGE,
  COX_MUTTA_LARGE_LAKE = NpcAttackProto.COX_MUTTA_LARGE_LAKE,
  COX_MUTTA_LARGE_MAGE = NpcAttackProto.COX_MUTTA_LARGE_MAGE,
  COX_MUTTA_LARGE_STOMP = NpcAttackProto.COX_MUTTA_LARGE_STOMP,
}
